  ...
  <body>
    ...
    <div class="sidebar container-fluid">
      <div class="row flex-nowrap" >
        ...
        <article style="position: absolute; margin-left:0px; margin-top: 0px; width: 1000px; height: 600px;">
                <div class="isi">
                <article style="position: absolute; margin-left: 250px; margin-top: -300px; width: 1000px; height: 600px;">
                <div class="isi">
                    <div class="judul">
