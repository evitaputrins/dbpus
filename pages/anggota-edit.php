...
?>
<center><div id="label-page"><h3>Edit Data Anggota</h3></div></center>
<div id="content">
	...
	<table id="tabel-input">
		...
		<tr>
			...
			<td class="isian-formulir"><input type="text" name="no_telp" value="<?php echo $r_tampil_anggota['no_telp']; ?>" class="isian-formulir isian-formulir-border"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<?php
			if($r_tampil_anggota['status']=="Tidak Meminjam")
			{
				echo "<td class='isian-formulir'><input type='radio' name='status' value='Tidak Meminjam' checked>Tidak Meminjam</label></td>
		</tr>
		<tr>
			<td class='label-formulir'></td>
			<td class='isian-formulir'><input type='radio' name='status' value='Sedang Meminjam'>Sedang Meminjam</td>";
			}
			elseif($r_tampil_anggota['status']=="Sedang Meminjam")
			{
				echo "<td class='isian-formulir'><input type='radio' name='status' value='Tidak Meminjam'>Tidak Meminjam</label></td>
		</tr>
		<tr>
			<td class='label-formulir'></td>
			<td class='isian-formulir'><input type='radio' name='status' value='Sedang Meminjam' checked>Sedang Meminjam</td>";
			}
			?>
		</tr>
		<tr>
