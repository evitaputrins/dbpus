        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <li><a class="dropdown-item" href="index.php?p=sejarah">Sejarah</a></li>
                <li><a class="dropdown-item" href="index.php?p=komputer">Ilmu Komputer</a></li>
                <li><a class="dropdown-item" href="index.php?p=karyasastra">Karya Sastra</a></li>
              </ul>
            </li>
          </ul>
        </div>
